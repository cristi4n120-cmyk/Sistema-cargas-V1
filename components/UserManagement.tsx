    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center p-8 animate-in fade-in zoom-in duration-500">
        ...
        <button 
          ...
          className="mt-10 px-12 py-5 bg-brand-navy dark:bg-white dark:text-brand-navy text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-premium hover:bg-brand-accent dark:hover:bg-brand-accent dark:hover:text-white hover:-translate-y-1 transition-all active:scale-95 btn-press"
        >
          Retornar ao Painel
        </button>
      </div>
